...
public class RawRedisInput extends MessageInput {

    private static final String NAME = "Raw/Plaintext Redis";

    @AssistedInject
    public RawRedisInput(MetricRegistry metricRegistry,
    ...
    @FactoryClass
    public interface Factory extends MessageInput.Factory<RawRedisInput> {
        @Override
