...
public class SyslogRedisInput extends MessageInput {

    private static final String NAME = "Syslog Redis";

    @AssistedInject
    public SyslogRedisInput(MetricRegistry metricRegistry,
                            @Assisted Configuration configuration,
                            RedisTransport.Factory transportFactory,
                            SyslogCodec.Factory codecFactory,
                            LocalMetricRegistry localRegistry,
                            SyslogRedisInputConfig config, Descriptor descriptor,
    ...
    @FactoryClass
    public interface Factory extends MessageInput.Factory<SyslogRedisInput> {
        @Override
        SyslogRedisInput create(Configuration configuration);

        @Override
        SyslogRedisInputConfig getConfig();
